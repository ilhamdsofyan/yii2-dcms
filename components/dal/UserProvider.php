...
use docotel\dcms\models\searchs\User as UserSearch;

class UserProvider implements
    \docotel\dcms\components\dal\IUserProvider,
    \docotel\dcms\components\dal\ILoginProvider,
    \docotel\dcms\components\dal\IResetProvider,
    \docotel\dcms\components\dal\IMessageUserProvider
{
    private static $user;
