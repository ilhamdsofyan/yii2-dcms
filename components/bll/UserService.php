...
class UserService implements \docotel\dcms\components\bll\IUserService
{
    ...
    {
        Yii::$container->setSingleton('docotel\dcms\components\dal\IUserGroupProvider',
            'docotel\dcms\components\dal\UserGroupProvider');
        Yii::$container->setSingleton('docotel\dcms\components\dal\IUserProvider',
            'docotel\dcms\components\dal\UserProvider');
        Yii::$container->setSingleton('docotel\dcms\components\dal\IMenuGroupProvider',
            'docotel\dcms\components\dal\GroupProvider');

        $this->userGroupProvider = Yii::$container->get('docotel\dcms\components\dal\IUserGroupProvider');
        $this->userProvider = Yii::$container->get('docotel\dcms\components\dal\IUserProvider');
        $this->groupProvider = Yii::$container->get('docotel\dcms\components\dal\IMenuGroupProvider');
    }
