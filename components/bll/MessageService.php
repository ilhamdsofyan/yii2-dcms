...
class MessageService implements IMessageService
{
    ...
    public function __construct() {
        ...
        $container->setSingleton('docotel\dcms\components\dal\IMessageProvider',
            'docotel\dcms\components\dal\MessageProvider');
        $this->messageProvider = $container->get('docotel\dcms\components\dal\IMessageProvider');

        $container->setSingleton('docotel\dcms\components\dal\IMessageUserGroupProvider',
            'docotel\dcms\components\dal\UserGroupProvider');
        $this->userGroupProvider = $container->get('docotel\dcms\components\dal\IMessageUserGroupProvider');

        $container->setSingleton('docotel\dcms\components\dal\IMessageUserProvider',
            'docotel\dcms\components\dal\UserProvider');
        $this->userProvider = $container->get('docotel\dcms\components\dal\IMessageUserProvider');

        $container->setSingleton('docotel\dcms\components\dal\IMessageGroupProvider',
            'docotel\dcms\components\dal\GroupProvider');
        $this->groupProvider = $container->get('docotel\dcms\components\dal\IMessageGroupProvider');
    }
    ...
    public function createMessage($post = null)
    {
        ...
        $send_message = Helper::def($message, 'send_message');
        $draft = (!empty($send_message)) ? '0' : '1';
