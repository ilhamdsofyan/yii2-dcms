          ...
          <div class="tab-content">
            ...
            <br/>
                <div class="form-group">
                  <input type="text" class="form-control input-sm search-list-menu" data-target="available" value="" placeholder="<?php echo Yii::t('rbac-dcms', 'Search Routes');?>">
                </div>
                <div class="well">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <?php echo Html::a(Yii::t('rbac-dcms', 'Select All'), 'javascript:void(0)', ['class' => 'a1', 'id' => 'route-select', ]);?>
                        <?php echo Html::submitButton(Yii::t('rbac-dcms', 'Add to Menu'), ['class' => 'btn btn-default pull-right', 'id' => 'add-group-to-menu']);?>
                    </div>
                </div>
            </div>
          </div>
  ...
  <div class="panel panel-default">
    ...
    <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
      <div class="panel-body">
        ...
        <div class="row">
            <div class="col-sm-12">
                <?php echo Html::submitButton(Yii::t('rbac-dcms', 'Add to Menu'), ['class' => 'btn btn-default pull-right', 'id' => 'add-custom-to-menu']) ?>
            </div>
        </div>
      </div>
    </div>
