$(document).ready(function(){
    ...
    var updateOutput = function(e){
        ...
        if (window.JSON) {
            ...
            AjaxCall('<?php echo Yii::$app->getUrlManager()->createUrl('dcms/menu/update-menu') ?>', {menus: JSON.parse(tmp)});
        }else{
                    ...
                    '<div class=\'panel-collapse collapse dd-nodrag\' id=\'' + id + '\' role=\'tabpanel\' aria-labelledby=\'' + id + '\'>' +
                            ...
                            '<div class=\'panel-body\'>' +
                                '<div class=\'form-group\'>' +
                                    ...
                                    '<input type=\'text\' class=\'form-control input-sm\' name=\'Menu[item][' + no + '][label]\' value=\'' + label + '\' placeholder=\' <?php echo Yii::t('rbac-dcms', 'Menu Label') ?> \'>' +
                                '</div>' +
                                '<div class=\'form-group\'>' +
                                    '<label><i> <?php echo Yii::t('rbac-dcms', 'Description') ?> </i></label>'+
                                    '<input type=\'text\' class=\'form-control input-sm\' name=\'Menu[item][' + no + '][description]\' placeholder=\' <?php echo Yii::t('rbac-dcms', 'Menu  Description') ?> \'>' +
                                '</div>' +
                                '<div class=\'form-group\'>' +
                                    '<label><i> <?php echo Yii::t('rbac-dcms', 'URL') ?> </i></label>' +
                                    '<input type=\'text\' class=\'form-control input-sm\' name=\'Menu[item][' + no + '][menu_url]\' value=\'' + url + '\' placeholder=\' <?php echo Yii::t('rbac-dcms', 'URL') ?> \'>' +
                                '</div>' +
                                '<div class=\'form-group\'>' +
                                    '<label><i> <?php echo Yii::t('rbac-dcms', 'Icon Class') ?> </i></label>' +
                                    '<input type=\'text\' class=\'form-control input-sm\' name=\'Menu[item][' + no + '][class]\' placeholder=\' <?php echo Yii::t('rbac-dcms', 'Icon Class') ?> \'>' +
                                '</div>' +
                                '<div class=\'form-group\'>' +
