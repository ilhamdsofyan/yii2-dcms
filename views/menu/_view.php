        ...
        <div class=" panel panel-success">
            ...
            <div class="panel-body">
                <div class="form-group">
                    <label><i><?php echo Yii::t('rbac-dcms', 'Menu Label');?></i></label>
                    <input type="text" class="form-control input-sm" name="Menu[item][<?php echo $i ?>][label]" value="<?php echo $menu->label?>" placeholder="<?php echo Yii::t('rbac-dcms', 'Menu Label');?>">
                </div>
                <div class="form-group">
                    <label><i><?php echo Yii::t('rbac-dcms', 'Description');?></i></label>
                    <input type="text" class="form-control input-sm" name="Menu[item][<?php echo $i ?>][description]" value="<?php echo $menu->description?>" placeholder="<?php echo Yii::t('rbac-dcms', 'Menu Description');?>">
                </div>
                <div class="form-group">
                    <label><i><?php echo Yii::t('rbac-dcms', 'URL');?></i></label>
                    <input type="text" class="form-control input-sm" name="Menu[item][<?php echo $i ?>][menu_url]" value="<?php echo $menu->menu_url?>" placeholder="<?php echo Yii::t('rbac-dcms', 'URL');?>">
                </div>
                <div class="form-group">
                    <label><i><?php echo Yii::t('rbac-dcms', 'Icon Class');?></i></label>
                    <input type="text" class="form-control input-sm" name="Menu[item][<?php echo $i ?>][class]" value="<?php echo $menu->class?>" placeholder="<?php echo Yii::t('rbac-dcms', 'Icon Class');?>">
                </div>
                <div class="form-group">
                    <div style="position:relative">
                        <label><i><?php echo Yii::t('rbac-dcms', 'Group');?></i></label>
                        <?php
                        if (!empty($listGroup)) {
