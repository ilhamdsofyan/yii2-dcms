...
use docotel\dcms\MenuAsset;

$this->title = Yii::t('rbac-dcms', 'List Menu');
$this->params['breadcrumbs'][] = ['label' => Yii::t('rbac-dcms', 'Menu'), 'url' => ['index']];
        ...
        <div class="col-lg-8">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <?php echo Yii::t('rbac-dcms', 'Group name :') ?>
                    <strong><?php echo $menuType?></strong>
                </div>
              <div class="panel-body">
                    <div class="row">
                        <div class="col-md-8">
                            <strong><?php echo Yii::t('rbac-dcms', 'Menu Structure') ?></strong>
                            <p><?php echo Yii::t('rbac-dcms', 'Drag each item into the order you prefer. Click the arrow on the right of the item to reveal additional configuration options.');?></p>
                        </div>
                        <div class="col-md-4">
                            <?php echo Html::submitButton(Yii::t('rbac-dcms', 'Save Menu <span class=\'fa fa-save\'></span>'), ['name'=> 'save', 'class' => 'btn btn-primary pull-right btn-save-menu']);?>
                        </div>
                    </div>
                    <div class="col-md-12">
