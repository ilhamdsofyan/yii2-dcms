...
/* @var $searchModel docotel\dcms\models\searchs\DclMedia */
        ...
        <div class="row">
          ...
          <!-- !Template layout Left Top Bar -->
            ...
            <div class="col-xs-5 text-right">
                <?php echo Html::a("<i class=\"fa fa-plus\"></i> ".Yii::t('app', 'Add Media'), Yii::$app->urlManager->createUrl(['dcms/media-library/add-content','id' => $media->media_id]), ['class' => 'btn btn-info']) ?>
                <div class="btn-group">
                        ...
                        <div class="row table-layout">
                            ...
                            <div class="col-xs-4 text-right va-m prn">
                                ...
                                <div class="btn-group">
                                    ...
                                    <?= Html::a("<i class=\"fa fa-trash\"></i>", Yii::$app->urlManager->createUrl(['dcms/media-library/delete-content','id' => $models->media_content_id]) ,['class'=>'btn btn-xs btn-info light','data' => [
                                          'confirm' => Yii::t('app', 'Are you sure you want to delete this item?'),
                                          'method' => 'post',
                                      ],] ) ?>

                                    <!-- <?= Html::a("<i class=\"fa fa-pencil\"></i>", Yii::$app->urlManager->createUrl(['dcms/media-library/update-image','id' => $models->media_content_id]) ,['class'=>'btn btn-xs btn-info'] ) ?> -->
              ...
              <div class="panel">
                ...
                <div class="panel-body">
                  ...
                  <div class="col-xs-12 text-right va-m prn pt10" >
                    <div class="btn-group">
                    <?= Html::a("<i class=\"fa fa-trash\"></i>", Yii::$app->urlManager->createUrl(['dcms/media-library/delete-content','id' => $models->media_content_id]) ,['class'=>'btn btn-sm btn-info light','onClick'=>'return confirm("Are you sure?")'] ) ?>

                      <!-- <?= Html::a("<i class=\"fa fa-pencil\"></i>", Yii::$app->urlManager->createUrl(['dcms/media-library/update-video','id' => $models->media_content_id]) ,['class'=>'btn btn-sm btn-info'] ) ?> -->
                    </div>
                  </div>
                  <!-- Panel Video Button -->
