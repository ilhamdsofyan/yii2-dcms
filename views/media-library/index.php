                ...
                <div class="panel p6 pbn">
                    <div class="of-h proportion-image">
                        ...
                        <?= Html::a("<img src=\"{$pathImage}\" class=\"img-responsive\" title=\"{$models->name}\">",
                            Yii::$app->urlManager->createUrl(['dcms/media-library/view','id' => $models->media_id]) ,['class'=>'fa fa-calendar'] ) ?>
                        ...
                        <div class="row table-layout">
                            ...
                            <div class="col-xs-4 text-right va-m prn">
                                ...
                                <div class="btn-group">
                                    ...
                                    <?= Html::a("<i class=\"fa fa-trash\"></i>", Yii::$app->urlManager->createUrl(['dcms/media-library/delete','id' => $models->media_id]) ,['class'=>'btn btn-xs btn-info light','data' => [
                                            'confirm' => Yii::t('app', 'Are you sure you want to delete this item?'),
                                            'method' => 'post',
                                        ],] ) ?>

                                    <?= Html::a("<i class=\"fa fa-pencil\"></i>", Yii::$app->urlManager->createUrl(['dcms/media-library/update','id' => $models->media_id]) ,['class'=>'btn btn-xs btn-info'] ) ?>

                                    <?= Html::a("<i class=\"fa fa-plus-circle\"></i>", Yii::$app->urlManager->createUrl(['dcms/media-library/add-content','id' => $models->media_id]) ,['class'=>'btn btn-xs btn-info dark'] ) ?>
                                </div>
