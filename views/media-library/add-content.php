...
<div class="row">
	<div class="col-sm-12 pl30 pr30">
		<div class="tray-bin pl10 mb10">
			...
			$type = $confType['type'];
			echo \docotel\dcms\widget\dropzone\DropZone::widget([ 
				'options' => [
					'url' => \Yii::$app->getUrlManager()->createUrl(['dcms/media-library/upload','id'=>$model->media_id]) ,
...
$urlPost = \Yii::$app->getUrlManager()->createUrl("dcms/media-library/uploadVideo");
$CheckYoutubeLinkWithoutApi = \Yii::$app->getUrlManager()->createUrl("dcms/media-library/check-youtube-link-without-api");
$script = <<< JS
