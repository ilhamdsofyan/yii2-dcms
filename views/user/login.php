...
<div class="admin-form theme-info mw500" id="login">
      ...
      <div class="panel-body bg-light p25 pb15">
        ...
        <?php
          if (Yii::$app->session->get('failattempts') >= 3) {
            echo $form->field($model, 'reCaptcha')->widget(\docotel\dcms\widget\recaptcha\ReCaptcha::className()) ;
          }
          ?>       
  ...
  <div class="login-links">
    <p>
      <?php echo Html::a('Forgot Password?', Yii::$app->urlManager->createUrl('dcms/user/request-password-reset'),['class'=>'active']) ?>
    </p>
