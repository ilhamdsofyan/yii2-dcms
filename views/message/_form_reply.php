...
<div class="message-form">
    ...
    <?php $form = ActiveForm::begin(['action' =>['/dcms/message/create'], 'method' => 'post',]); ?>
    ...
    <div class="form-group">
        <?php echo Html::submitButton(empty($model->message_id) ? Yii::t('rbac-dcms', 'Create') :
            Yii::t('rbac-dcms', 'Update'), ['class' =>empty($model->message_id) ? 'btn btn-success' : 'btn btn-primary']) ?>
