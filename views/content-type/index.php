...
/* @var $searchModel docotel\dcms\models\searchs\DclNodeType */
                        ...
                        [
                            ...
                            'buttons' => [
                                ...
                                'update' => function ($url, $model) {
                                    return Html::a(Yii::t('app','update'), Yii::$app->urlManager->createUrl(['dcms/content-type/update','id' => $model->node_type,'edit'=>'t']), [
                                ...
                                'manageFields' => function ($url, $model) {
                                    return Html::a(Yii::t('app','manage fields'), Yii::$app->urlManager->createUrl(['dcms/content-type/manage-fields','id' => $model->node_type]), [
                                ...
                                'manageCategory' => function ($url, $model) {
                                    return Html::a(Yii::t('app','manage category'), Yii::$app->urlManager->createUrl(['dcms/content-type/manage-category','id' => $model->node_type]), [
                                ...
                                'delete' => function ($url, $model) {
                                    return Html::a(Yii::t('app','delete'), Yii::$app->urlManager->createUrl(['dcms/content-type/delete','id' => $model->node_type,'delete'=>'t']), [
                                            'title' => Yii::t('app', 'delete'),
                                            // 'class' => 'btn btn-danger btn-sm',
                                            'data' => [
                                                'confirm' => Yii::t('yii','Are you sure you want to delete this item?'),
