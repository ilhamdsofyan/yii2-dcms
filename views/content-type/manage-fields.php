                        ...
                        [
                            ...
                            'buttons' => [
                                ...
                                'update' => function ($url, $model) {
                                    return Html::a(Yii::t('app','update'), Yii::$app->urlManager->createUrl(['dcms/content-type/fields-update','id' => $model->id,'edit'=>'t']), [
                                ...
                                'delete' => function ($url, $model) {
                                    return Html::a(Yii::t('app','delete'), Yii::$app->urlManager->createUrl(['dcms/content-type/fields-delete','id' => $model->id,'delete'=>'t']), [
