...
/* @var $searchModel docotel\dcms\models\searchs\DclFieldDataBody */
                    ...
                    <?= GridView::widget([
                        ...
                        'columns' => [
                            ...
                            [
                                'attribute' => 'node_type',
                                // 'filter' => ['a'=> 'b'],
                                'filter' => yii\helpers\ArrayHelper::map(\docotel\dcms\models\DclNodeType::find()->all(), 'node_type', 'name'),
