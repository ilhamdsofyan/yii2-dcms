...
use docotel\dcms\models\DclMediaContent as DclMediaContentModel;

/**
 * DclMediaContent represents the model behind the search form about `docotel\dcms\models\DclMediaContent`.
 */
