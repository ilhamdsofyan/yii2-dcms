...
use docotel\dcms\models\DclFieldDataBody as DclFieldDataBodyModel;

/**
 * DclFieldDataBody represents the model behind the search form about `docotel\dcms\models\DclFieldDataBody`.
 */
