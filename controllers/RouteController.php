...
class RouteController extends BaseController
{
    ...
    {
        Yii::$container->setSingleton('docotel\dcms\components\bll\IRouteService',
            'docotel\dcms\components\bll\RouteService');
        $this->routeService = Yii::$container->get('docotel\dcms\components\bll\IRouteService');
