...
class AllowedController extends BaseController
{
    ...
    {
        Yii::$container->setSingleton('docotel\dcms\components\bll\IAllowedService',
            'docotel\dcms\components\bll\AllowedService');
        $this->allowedService = Yii::$container->get('docotel\dcms\components\bll\IAllowedService');
