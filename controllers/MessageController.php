...
use docotel\dcms\models\form\Message as MessageForm;
...
class MessageController extends BaseController
{
    ...
    public function __construct($id, $modules, $config = [])
    {
        ...
        Yii::$container->setSingleton('docotel\dcms\components\bll\IMessageService',
            'docotel\dcms\components\bll\MessageService');
        $this->messageService = Yii::$container->get('docotel\dcms\components\bll\IMessageService');
    ...
    {
        $message = $this->loadModel('\docotel\dcms\models\Message', $id);
        $model = new MessageForm();
        $model->attributes = $message->attributes;

        if ($model->load(Yii::$app->request->post())) {
            return $this->redirect('/dcms/message');
        }
    ...
    {
        $user = Helper::def(Yii::$app->user->identity, 'username');
        $model = $this->loadModel('\docotel\dcms\models\Message', $id);
    ...
    {
        $user = Helper::def(Yii::$app->user->identity, 'username');
        $modelMessage = $this->loadModel('\docotel\dcms\models\Message');
        $this->messageService->readMessage($id, $user);
