...
use docotel\dcms\models\DclMediaContent;
...
class MediaLibraryController extends BaseController
{
    ...
    {
        Yii::$container->setSingleton('docotel\dcms\components\bll\IMediaService',
            'docotel\dcms\components\bll\MediaService');
        $this->mediaService = Yii::$container->get('docotel\dcms\components\bll\IMediaService');
