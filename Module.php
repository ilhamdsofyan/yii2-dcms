...
class Module extends \yii\base\Module
{
     ...
     * Its used when `layout` set to 'left-menu', 'right-menu' or 'top-menu'.
     */
    public $mainLayout = '@docotel/dcms/views/layouts/main.php';
    /**
     * @var array 
     * @see [[menus]]
     */
    ...
    public function init()
    {
        ...
        Yii::$app->setComponents([
                    ...
                    'reCaptcha' => [
                        'name' => 'reCaptcha',
                        'class' => 'docotel\dcms\widget\recaptcha\ReCaptcha',
        ...
        if (!isset(Yii::$app->i18n->translations['rbac-dcms'])) {
            Yii::$app->i18n->translations['rbac-dcms'] = [
                'class' => 'yii\i18n\PhpMessageSource',
                'sourceLanguage' => 'en',
                'basePath' => '@docotel/dcms/messages'
            ];
        }
        ...
        if ($this->navbar === null && Yii::$app instanceof \yii\web\Application) {
            $this->navbar = [
                ['label' => Yii::t('rbac-dcms', 'Help'), 'url' => ['default/index']],
                ['label' => Yii::t('rbac-dcms', 'Application'), 'url' => Yii::$app->homeUrl]
            ];
        }
        if (class_exists('yii\jui\JuiAsset')) {
            Yii::$container->set('docotel\dcms\AutocompleteAsset', 'yii\jui\JuiAsset');
        }
    }
        ...
        if ($this->_normalizeMenus === null) {
            ...
            foreach ($this->_coreItems as $id => $lable) {
                if (!isset($conditions[$id]) || $conditions[$id]) {
                    $this->_normalizeMenus[$id] = ['label' => Yii::t('rbac-dcms', $lable), 'url' => [$mid . $id]];
                }
            }
            foreach (array_keys($this->controllerMap) as $id) {
                $this->_normalizeMenus[$id] = ['label' => Yii::t('rbac-dcms', Inflector::humanize($id)), 'url' => [$mid . $id]];
            }
    ...
    public function beforeAction($action)
    {
        if (parent::beforeAction($action)) {
            ...
            $view->params['breadcrumbs'][] = [
                'label' => ($this->defaultUrlLabel ?: Yii::t('rbac-dcms', 'Admin')),
